        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
            ...
            <UCard>
                ...
                <div class="text-xs text-gray-500">
                    ${{ metrics.paymentsReceived.toLocaleString() }} / ${{ metrics.paymentsTarget.toLocaleString() }}
                </div>
            </UCard>
            <UCard>
                <template #header>
                ...
                <div class="text-2xl font-semibold">{{ metrics.passportsUploaded }} / {{ metrics.waiversSigned }}</div>
